...
import type { BlockDefinition, FieldDefinition, FieldType } from "@/block-builder/types";
import type { RawFieldInput } from "@/builder/types";

// Reverse of mapToSaveRequest — maps DB field types back to builder types
...
function fieldToBuilderField(raw: RawFieldInput): FieldDefinition {
  ...
  // Carry over type-specific props
  ...
  // also handle explicit relationTo coming back from normalizer
